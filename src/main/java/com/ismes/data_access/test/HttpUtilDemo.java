...
public class HttpUtilDemo {
	...
	public static void main(String[] args) {
		...
		params.put("orderData", "[\"cfg_MachineId\",\"sys_time\",\"modestatus\",\"cncrunlevel\"]");
		params.put("orderType", "6666");
		params.put("level", "0");
		params.put("frequence", "10000");
		params.put("switchs", "on");
		params.put("destination1", "SMTCL_MACHINE_T81_3ouMg_testClient");
		params.put("cmdId", "ytre");
		try {
//			HttpUtilDemo.get("https://api.i5sesol.com/agentServer/order/getAllMachine", null);
			HttpUtilDemo.post("https://api.i5sesol.com/agentServer/order/jsonOrder", null, params);
		} catch (IOException e) {
